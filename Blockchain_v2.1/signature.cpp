...
void Signature::encrypt(string privKey){
	BIO *bufio;
    RSA *rsa;
    unsigned int byteCount = 251;
    //cout << pubKey << endl;
    bufio = BIO_new_mem_buf((void*)privKey.c_str(), byteCount);
    ...
    cout << kekInput << endl;
	outlen = RSA_public_encrypt(117, kekInput, kekOutput, myRSA, RSA_PKCS1_PADDING);
